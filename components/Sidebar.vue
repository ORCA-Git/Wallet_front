        ...
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <div class="user-profile">
                <div class="dropdown user-pro-body">
                    <div><img src="~/assets/images/users/varun.jpg" alt="user-img" class="img-circle"></div>
                    <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Orca Company<span class="caret"></span></a>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                  <NuxtLink to="/login" class="waves-effect">
