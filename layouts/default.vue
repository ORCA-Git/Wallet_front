<template>
  <div class="fullpage-wrapper">
    <Modalalert v-if="this.$nuxt.$store.state.alertmodal != ''" />
    <Navbar />
    <sidebar v-if="this.$nuxt.$store.state.expandsidebar == true" />
    <div class="page-wrapper" v-bind:class="{ expanded: this.$nuxt.$store.state.expandsidebar == true }">
...
<style lang="less">
  ...
  * {
  ...
  .bg-theme-alt {
      background-color: @themealt !important;
  }
  .bg-theme {
